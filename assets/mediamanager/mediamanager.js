(function (root, factory) {
    ...
    var initializeEvents = function() {
      ...
      */
      ...
      // Close button
      _.element.querySelector('.mediamanager-header-close__button').addEventListener('click', function () {
        Mediamanager.prototype.close.call(_);
      });
    ...
    var _buildHeader = function () {
      ...
      var _mediamanagerHeaderElement = document.createElement('div'),
          ...
          _mediamanagerHeaderRightCloseElement = document.createElement('img');
      ...
      _mediamanagerHeaderRightCloseElement.classList.add('mediamanager-header-close__button');
      _mediamanagerHeaderRightCloseElement.alt = 'Close icon selector dialogue';
      _mediamanagerHeaderRightCloseElement.src = '../wp-content/themes/wp98/assets/images/main/close-button.png';
      ...
      _mediamanagerHeaderElementRight.appendChild(_mediamanagerHeaderRightCloseElement);
